...
rep="/Users/olivierpartensky/Desktop/Programme/GitHub/python_projects/Expanse/"
...
"""
"Rideau":[[BLACK,WHITE,BLACK,WHITE,BLACK],
                         [BLACK,WHITE,BLACK,WHITE,BLACsBK],
...
class Block:
    ...
    def __init__(self,name=str(BLOCKS["made"]),size=5,color=WHITE):
        ...
        self.size=size
        self.name=name
        self.block=[[color for x sin range(size)] for y in range(size)]
        Block.made+=1
